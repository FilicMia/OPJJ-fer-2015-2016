...
/**
 * Integer Observer which prints in standard output double of value stored in
 * storage only for n times.
 * 
 * 
 * @author Mia Filić
 *
...
public class DoubleValue implements IntegerStorageObserver {
	...
	public void valueChanged(IntegerStorageChange istorage) {
		...
		if (number >= 0) {
			System.out.println("Double value: " + TWO * istorage.getAfter());
